/**
 * Fork of https://www.npmjs.com/package/cookiefile 
 * Fixed bug https://github.com/Horat1us/node-cookiefile/issues/1 (overwriting element with the same key)
 * Removed unneccesary dependency - used fs.existsSync instead
 */
"use strict";
module.exports = {
    Cookie: class Cookie {
    ...
    CookieMap: class CookieMap extends Map {
        ...
        set(cookie) {
            ...
            super.set(`${cookie.domain}-${cookie.name}-${randomString}`, cookie);
